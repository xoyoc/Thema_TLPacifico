...
jQuery(document).ready(function ($) {
  ...
  var marker_url = (is_internetExplorer11) ? get_template_directory_uri() .'/img/widgets/gmap/cd-icon-location.png' : get_template_directory_uri() .'/img/widgets/gmap/cd-icon-location.svg'
