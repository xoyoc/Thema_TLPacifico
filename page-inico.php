       ...
       <!--========== LAMINAS DE INICIO ==========-->
        <div class="s-swiper js__swiper-one-item">
            ...
            <div class="swiper-wrapper">
                <div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('<?php echo get_template_directory_uri(); ?>/img/Home-Slider1.jpg');">
                    <div class="container g-text-center--xs g-ver-center--xs">
                        <div class="g-margin-b-30--xs">
                            <h1 class="g-font-size-35--xs g-font-size-45--sm g-font-size-55--md g-color--white textoMayusculas">Logística sin límites<br>Unlimited Logistics</h1>
                        </div>
                ...
                <div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('<?php echo get_template_directory_uri(); ?>/img/Home-Slider2.jpg');">
                    <div class="container g-text-center--xs g-ver-center--xs">
                        <div class="g-margin-b-30--xs">
                            <div class="g-margin-b-30--xs">
                                <h2 class="g-font-size-35--xs g-font-size-45--sm g-font-size-55--md g-color--white textoMayusculas">Logística sin límites<br>Unlimited Logistics</h2>
                            </div>
            ...
            <a href="#js__scroll-to-section" class="s-scroll-to-section-v1--bc g-margin-b-15--xs">
                ...
                <p class="text-uppercase g-color--white g-letter-spacing--3 g-margin-b-0--xs">Conoce más</p>
            </a>
        </div>
        <!--========== FIN DE LAMINAS ==========-->
            ...
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                <div class="row">
                    <div class="col-md-4 g-margin-t-15--xs g-margin-b-60--xs g-margin-b-0--lg">
                        <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--red g-letter-spacing--2 g-margin-b-25--xs">Descubre</p>
                    ...
                    <div class="col-md-4 col-md-offset-1">
                        <p class="g-font-size-16--xs textoJustificado g-font-weight--700">Somos una empresa consolidada como Agencia de Carga especializada en operaciones logísticas a nivel internacional, con la finalidad de ofrecer servicios profesionales altamente eficientes.</p>
                        <p class="g-font-size-16--xs textoJustificado g-font-weight--700">Nos adaptamos a las necesidades del cliente, optimizando costos y tiempos de tránsito con un servicio personalizado de primera calidad, brindando siempre las mejores tarifas de cualquier puerto del mundo.</p>
                        <p class="g-font-size-16--xs textoJustificado g-font-weight--700">Tenemos la experiencia para facilitar sus exportaciones e importaciones, sin importar que sean del océano Pacifíco o del Atlántico.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="container g-text-center--xs g-padding-y-80--xs g-padding-y-125--sm">
                <div class="g-margin-b-80--xs">
                    <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white tituloEslogan">
                     Facilitamos su operación con rapidez, transparencia y eficiencia
                    </h2>
                </div>
                <a href="servicios" class="text-uppercase s-btn s-btn--md s-btn--white-brd g-radius--50">CONOCE NUESTROS SERVICIOS</a>
            </div>
        </div>
        <!-- End Parallax -->
       ...
       <!-- Navieras -->
        <div class="g-bg-color--sky-light">
            <div class="g-container--md g-padding-y-20--xs g-padding-y-50--sm sinPaddingBottom">
                <!-- Swiper Navieras -->
                <h3 class="tituloGris">Alianzas Navíeras</h3>
                ...
                <div class="g-container--md g-padding-y-20--xs g-padding-y-50--sm">
                    <h3 class="tituloGris">Asociaciones</h3>
        ...
        <div class="container g-padding-y-20--xs g-margin-b-30--xs">
            ...
            <a href="#" class="text-uppercase s-btn s-btn--md s-btn--red-brd g-radius--50">VER MÁS NOTICIAS</a>
        </div>        
        <!-- Fin Noticias -->
	</main>
